...
export const Home = ({ sub }) => {
    ...
    const showSubPanel = () => {
        switch (sub) {
            case 'home':
                return <SubHome subPageActive={subHomePageActive} setSubPageActive={setSubHomePageActive} activeCourseId={activeCourseId} setActiveCourseId={setActiveCourseId} />;
            case 'live':
    ...
    return (
        <div className="page">
            <div className="mainpage">
                <Map sub={sub} activeCourseId={activeCourseId} courseData={activeCourseId === 0? course65: course100} distance={distance} />
                { sub === 'terrain' ?
